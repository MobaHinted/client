...
class GameReturn(TypedDict, total=False):
    ...
    players_key_rune: Required[list[list[str]]]
    players_secondary_rune_tree: Required[list[list[str]]]
...
class MatchData:
    ...
    # noinspection PyTypeChecker,DuplicatedCode
    @cached_property
    def _players_damage(self) -> list[list[int]]:
        players_damage = [[], []]
    ...
    # noinspection PyTypeChecker,DuplicatedCode
    @cached_property
    def _players_vision(self) -> list[list[int]]:
        players_vision = [[], []]
